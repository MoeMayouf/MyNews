...
import com.mayouf.news.common.Constants;
import com.mayouf.news.data.service.DataSource;
import com.mayouf.news.data.service.DataSourceImpl;
import com.mayouf.news.data.service.NewsService;
...
public class NetworkModule {
    ...
    @Provides
    @Singleton
    public NewsService provideLastFMService(Retrofit retrofit) {
    ...
    @Remote
    @Singleton
    public DataSource provideRemoteDataSource(NewsService newsService) {
        return new DataSourceImpl(newsService);
    }
